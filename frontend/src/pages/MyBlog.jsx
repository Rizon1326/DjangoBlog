...
const MyBlog = () => {
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `http://0.0.0.0:8000/blog/${fullBlog.id}/edit/`,
        {
          method: "PUT",
          headers: {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 relative">
      ...
      {showToast && (
        <div
          className={`fixed top-5 right-5 z-50 p-4 rounded-md shadow-lg flex items-center justify-between transition-all duration-300 ${
            toastType === "success"
