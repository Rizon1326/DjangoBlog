...
from .views import Register,VerifyOTP, Login, BlogList, BlogDetail, BlogCreate, BlogEdit,BlogDelete, CommentCreate, CommentEdit, CommentDelete, CommentView, CommentReply
